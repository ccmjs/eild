...
//    "feedback": true,
      ...
      "html": [ "ccm.load", "https://ccmjs.github.io/eild/mc/resources/templates-v3.mjs" ],
    ...
    Instance: function () {
      ...
      const events = {
        ...
        onSubmit: event => {
          ...
          this.onchange && this.onchange( { event: 'submit', data });
        ...
        onRetry: () => {
          const question = data.questions[ data.nr - 1 ];
          question.answers.forEach( answer => delete answer.input );
          this.onchange && this.onchange( { event: 'retry', data });
          render();
        },
        ...
        onNext: () => {
          ...
          data.nr++;
          render();
          this.onchange && this.onchange( { event: 'next', data });
        },
