      ...
      <div class="p-2 d-flex justify-content-between align-items-center border-bottom answer${ app.feedback && answer.input !== undefined && ' ' + ( answer.input === '' ? 'none' : answer.input === answer.solution ? 'correct' : 'wrong' ) || '' }">
        ...
        <div class="ms-2">
          <div class="btn-group btn-group-sm" role="group" aria-label="Basic radio toggle button group">
            ...
            ` : ''}
            <input type="radio" class="btn-check" name="input.${ i }" value="false" id="answer-${ nr }-3" autocomplete="off" .disabled="${ answer.input !== undefined }" ?checked="${ answer.input === false || !app.btn_neutral && (answer.input === undefined || answer.input === '') }">
