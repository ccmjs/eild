          ...
          <div id="erb-general-collapse" class="collapse show" aria-labelledby="erb-general-heading" data-parent="#erb-accordion">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <span type="button" data-toggle="collapse" data-target="#erb-info-shuffle" aria-expanded="false" aria-controls="erb-info-shuffle">
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle-fill text-info mb-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM8 5.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                  </svg>
                </span>
                <div class="collapse" id="erb-info-shuffle">
                  <div class="bg-info text-light rounded p-2">
                    If enabled, the phrases are mixed so that they are questioned in a different order each time.
                  </div>
                </div>
              </div>
 ...
 */
function phraseRow( phrase, onShowPhrase, onDeletePhrase ) {
  return html`
    <tr>
      ...
      <td class="text-right text-nowrap">
        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#erb-phrase-${phrase.key}">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
            <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
          </svg>
        </button>
        <button type="button" class="btn btn-info btn-sm" data-key="${phrase.key}" @click="${onShowPhrase}">
...
function phraseModal( config, phrase ) {
  return html`
    <div id="erb-phrase-${phrase.key}" class="modal" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
