 ...
 * @version 4.0.0
 * @changes
 * version 4.0.0 (20.05.2022)
 * - uses helper.mjs v8.2.0 as default
 * - uses resources.mjs v3 as default
 * - uses templates.mjs v4 as default
 * - support of ternary relations (up to 4 entities)
 * - ternary relations are only displayed in 'abrial' notation
 * (for older version changes see ccm.er_trainer-3.0.0.js)
 */
...
//    "data": { "store": [ "ccm.store" ] },
      ...
      "html": [ "ccm.load", "https://ccmjs.github.io/eild/er_trainer/resources/templates-v4.mjs" ],
//    "lang": [ "ccm.start", "https://ccmjs.github.io/akless-components/lang/versions/ccm.lang-1.1.0.min.js" ],
      ...
      "notations": [ "ccm.load", "https://ccmjs.github.io/eild/er_trainer/resources/resources-v3.mjs#notations" ],
//    "number": 1,
//    "onchange": event => console.log( event ),
      "onfinish": { "restart": true },
//    "onready": event => console.log( event ),
//    "onstart": event => console.log( event ),
      "phrases": [ "ccm.load", "https://ccmjs.github.io/eild/er_trainer/resources/resources-v3.mjs#phrases" ],
      "retry": true,
      "show_solution": true,
      "shuffle": true,
      "text": [ "ccm.load", "https://ccmjs.github.io/eild/er_trainer/resources/resources-v3.mjs#en" ],
